...
#path1="/home/LBS_ZHAOLIN/graph_analysis/block_chain/token_trf/2017_token_trf/"
...
# print("finsh graph3: ", datetime.datetime.now())
...
# # keep_states = list(sorted(list(nx.strongly_connected_components(diG)),key = len, reverse=True)[0])



# keep_states = list(nx.strongly_connected_components(diG))
# keep_states1 = list(nx.strongly_connected_components(diG))[1]
# keep_states.sort()
...
print("finsh graph4: ", datetime.datetime.now())
...
# print('-transaction 2016 net ---')
# print('# of edges multi: {}'.format(multidiG.number_of_edges()))
# print(' # of self loop multi: {}'.format(nx.number_of_selfloops(multidiG)))
# print('# of edges, un: {}'.format(simpleG.number_of_edges()))
# print(' # of self loop un: {}'.format(nx.number_of_selfloops(simpleG)))
