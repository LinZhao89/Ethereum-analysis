...
with open(g, "r") as gFile:
    with open(path+"transaction_net_address_hash_2016.csv", "w", newline ='') as hfile:
        with open(path+"transaction_net_2016.csv", "w",  newline ='') as tfile:
